...
#> Running command (2025-04-04 02:14:11): echo $TEST
#> 
#> blit is awesome
...
> remains the same.
    ...
    #> Running command (2025-04-04 02:14:12): echo $TEST
    #> blit is awesome
...
#> Running command (2025-04-04 02:14:12): ping localhost
#> Running command (2025-04-04 02:14:12): ping 208.67.222.222
#> Running command (2025-04-04 02:14:12): ping 8.8.8.8
#> Running command (2025-04-04 02:14:12): ping 8.8.4.4
#> 
#> Connection 1: PING localhost (::1) 56 data bytes
#> Connection 1: 64 bytes from localhost (::1): icmp_seq=1 ttl=64 time=0.028 ms
#> ⠙ 0/4 [0/s] [elapsed in 87ms] @ 2025-04-04 02:14:12
#> ⠹ 0/4 [0/s] [elapsed in 304ms] @ 2025-04-04 02:14:12
#> ⠸ 0/4 [0/s] [elapsed in 515ms] @ 2025-04-04 02:14:12
#> ⠼ 0/4 [0/s] [elapsed in 725ms] @ 2025-04-04 02:14:12
#> ⠴ 0/4 [0/s] [elapsed in 946ms] @ 2025-04-04 02:14:13
#> ⠦ 0/4 [0/s] [elapsed in 1.2s] @ 2025-04-04 02:14:13
#> ⠧ 0/4 [0/s] [elapsed in 1.4s] @ 2025-04-04 02:14:13
#> ⠇ 0/4 [0/s] [elapsed in 1.6s] @ 2025-04-04 02:14:13
#> Connection 1: 64 bytes from localhost (::1): icmp_seq=2 ttl=64 time=0.040 ms
#> ⠏ 0/4 [0/s] [elapsed in 1.6s] @ 2025-04-04 02:14:13
#> ⠋ 0/4 [0/s] [elapsed in 1.8s] @ 2025-04-04 02:14:14
#> ⠙ 0/4 [0/s] [elapsed in 2s] @ 2025-04-04 02:14:14
#> ⠹ 0/4 [0/s] [elapsed in 2.2s] @ 2025-04-04 02:14:14
#> Connection 1: 64 bytes from localhost (::1): icmp_seq=3 ttl=64 time=0.044 ms
#> ⠸ 0/4 [0/s] [elapsed in 2.2s] @ 2025-04-04 02:14:14
#> ⠼ 0/4 [0/s] [elapsed in 2.4s] @ 2025-04-04 02:14:14
#> ⠴ 0/4 [0/s] [elapsed in 2.7s] @ 2025-04-04 02:14:14
#> ⠦ 0/4 [0/s] [elapsed in 2.9s] @ 2025-04-04 02:14:15
#> ⠧ 0/4 [0/s] [elapsed in 3.1s] @ 2025-04-04 02:14:15
#> ⠇ 0/4 [0/s] [elapsed in 3.3s] @ 2025-04-04 02:14:15
#> ⠏ 0/4 [0/s] [elapsed in 3.5s] @ 2025-04-04 02:14:15
#> ⠋ 0/4 [0/s] [elapsed in 3.7s] @ 2025-04-04 02:14:15
#> Connection 1: 64 bytes from localhost (::1): icmp_seq=4 ttl=64 time=0.041 ms
#> ⠙ 0/4 [0/s] [elapsed in 3.7s] @ 2025-04-04 02:14:15
#> ⠹ 0/4 [0/s] [elapsed in 3.9s] @ 2025-04-04 02:14:16
#> ⠸ 0/4 [0/s] [elapsed in 4.1s] @ 2025-04-04 02:14:16
#> ⠼ 0/4 [0/s] [elapsed in 4.1s] @ 2025-04-04 02:14:16
#> Command process finished
#> Command process finished
#> Command process finished
#> Command process finished
#> ⠼ 4/4 [0.96/s] [elapsed in 4.2s] @ 2025-04-04 02:14:16
...
exec("echo", "$(pwd)") |>
    cmd_wd(tempdir()) |>
    cmd_run(stdout = "|")
#> Working Directory: '/tmp/RtmplnhSVw'
#> Running command (2025-04-04 02:14:16): echo $(pwd)
#> 
#> /tmp/RtmplnhSVw
#> Command process finished
#> System command succeed
...
#> Running command (2025-04-04 02:14:16): echo $TEST
#> 
...
#> Running command (2025-04-04 02:14:16): echo $PATH
#> 
#> PATH_IS_HERE
#> Command process finished
#> System command succeed
...
``` r
appmamba()
#> Running command (2025-04-04 02:14:19):
...
#> Running command (2025-04-04 02:14:20):
#> /home/runner/.local/share/R/blit/apps/appmamba/bin/micromamba --root-prefix
...
exec("which", "samtools") |>
    ...
    cmd_run()
#> Setting environment variables: PATH
#> Running command (2025-04-04 02:14:32): which samtools
#> Command process finished
#> System command succeed
```
...
#> Running command (2025-04-04 02:14:32):
#> /home/runner/.local/share/R/blit/apps/appmamba/bin/micromamba --root-prefix
...
#> Running command (2025-04-04 02:14:32): ping localhost
#> 
...
exec("ping", "localhost") |>
    ...
    cmd_run(timeout = 5, stdout = "|") # terminate it after 5s
#> Running command (2025-04-04 02:14:37): ping localhost
#> 
#> PING localhost (::1) 56 data bytes
#> 64 bytes from localhost (::1): icmp_seq=1 ttl=64 time=0.018 ms
#> 64 bytes from localhost (::1): icmp_seq=2 ttl=64 time=0.032 ms
...
exec("ping", "localhost") |>
    ...
    cmd_run(timeout = 5, stdout = "|") # terminate it after 5s
#> Running command (2025-04-04 02:14:43): ping localhost
#> 
#> PING localhost (::1) 56 data bytes
#> 64 bytes from localhost (::1): icmp_seq=1 ttl=64 time=0.018 ms
...
#> Running command (2025-04-04 02:14:48): /usr/bin/python --help
#> 
...
#> Running command (2025-04-04 02:14:48): /usr/bin/perl --help
#> 
#> 
...
exec("gzip", "-c", file) |>
    exec("gzip", "-d", ">", file2) |>
    cmd_run(stdout = "|")
#> Running command (2025-04-04 02:14:48): gzip -c /tmp/RtmplnhSVw/file1db1270b375c
#> | gzip -d > /tmp/RtmplnhSVw/file1db16de034ca
#> Command process finished
#> System command succeed
...
#> Running command (2025-04-04 02:14:48): /usr/bin/ping 8.8.8.8
#> Command process finished
#> Warning: System command timed out in 5 secs (status: -9)
```
